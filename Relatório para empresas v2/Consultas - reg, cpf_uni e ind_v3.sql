...
CREATE VIEW SUL.TABELAO_VIEW_REG AS 
...
SELECT 
    ...
    (T1.QTDE_ESTOQUE_INICIAL + T1.QTDE_ESTOQUE_FINAL)/2 AS EXPOSIÇÃO, 
    T2.QTDE_GERAL_SA,
    T2.INV_ACI, 
    T2.INV_ACI_TB, 
    T2.INV_DOE, 
...
FROM CTE_AT_INV AS T1
LEFT JOIN CTE_SA_INV AS T2
ON  
...
FROM CTE_AT_INV AS T3
RIGHT JOIN CTE_SA_INV AS T4
ON  
...
CREATE VIEW TABELAO_VIEW_CPF_UNI AS 
